  ...
  return (
    <div className="flex flex-col gap-5 p-6">
      ...
      <div className="flex flex-col gap-4 lg:flex-row">
        ...
        <div className="flex-1 rounded-xl border-2 border-[#85B7EB] bg-[#E6F1FB] p-4">
          ...
          <div className="mt-2.5 flex flex-wrap gap-2.5">
            <InputMoeda label="Saldo Inicial" value={saldoInicial} onChange={setSaldoInicial} className="w-36" />
        ...
        <div className="flex-1 rounded-xl border-2 border-[#FAC775] bg-[#FAEEDA] p-4">
          ...
          <div className="mt-2.5 flex flex-wrap gap-2.5">
            <InputMoeda label="Limite" value={limite} onChange={setLimite} className="w-36" />
            <label className="flex w-44 flex-col gap-1">
              <span className="text-xs font-medium text-gray-600">Banco vinculado</span>
              <select
                value={bancoCartaoId}
      ...
      <div className="rounded-xl bg-[#EAF3DE] p-4">
        ...
        <div className="mt-2.5 flex flex-wrap gap-2.5">
          <InputMoeda label="Valor" value={transfValor} onChange={setTransfValor} className="w-36" />
          <CampoSimples label="Data" value={transfData} onChange={setTransfData} className="w-32" />
          <CampoSimples label="Descrição" value={transfDesc} onChange={setTransfDesc} className="w-64" />
        </div>
